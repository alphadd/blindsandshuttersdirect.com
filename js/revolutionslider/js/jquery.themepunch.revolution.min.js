...
(function (e, t) {
    ...
    function d(e, t) {
        if (t.touchenabled == "on") {
            var n = Hammer(e, {drag_block_vertical: t.drag_block_vertical, swipe_velocity: t.swipe_velocity, swipe_max_touches: t.swipe_max_touches, swipe_min_touches: t.swipe_min_touches, prevent_default: true});
    ...
    function L(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (d == 6)R = .6;
            TweenLite.fromTo(H, X, {left: j, top: F, scale: R, opacity: I, rotation: r.rotate}, {opacity: 1, rotation: 0, left: 0, top: 0, scale: 1, ease: z, onComplete: function () {
                B(n, r, f, a, u, i);
            ...
            if (d != 1) {
                if (l == 12)TweenLite.to($, V, {left: 0 - D + "px", scale: q, opacity: I, rotation: r.rotate, ease: U}); else if (l == 15)TweenLite.to($, V, {left: D + "px", scale: q, opacity: I, rotation: r.rotate, ease: U}); else if (l == 13)TweenLite.to($, V, {top: 0 - P + "px", scale: q, opacity: I, rotation: r.rotate, ease: U}); else if (l == 14)TweenLite.to($, V, {top: P + "px", scale: q, opacity: I, rotation: r.rotate, ease: U})
            }
            u.css({opacity: 1})
        }
        if (l == 16) {
            ...
            if (c == 0) {
                                    ...
                                    var a = setInterval(function () {
                                        if (YT != t)if (typeof YT.Player != t && typeof YT.Player != "undefined") {
                                            if (l.data("autoplay") == true) {
                                                u = new YT.Player(h, {events: {onStateChange: j, onReady: function (e) {
                                                    e.target.playVideo()
                                                }}})
                ...
                if (!i) {
                    ...
                    if (l.hasClass("customin")) {
                        if (W != l)F.add(TweenLite.set(l, {opacity: 1, scaleX: 1, scaleY: 1, rotationX: 0, rotationY: 0, rotationZ: 0, skewX: 0, skewY: 0, z: 0, x: 0, y: 0, visibility: "visible", opacity: 1, delay: 0, overwrite: "all"}));
                        V.visibility = "hidden";
                ...
                u.find(".tp-caption iframe").each(function (t) {
                    try {
                        if (e(this).attr("src").indexOf("vim") > 0 && T == 0) {
                            T = 1;
                            var n = document.createElement("script");
                            n.src = k + "://a.vimeocdn.comjs/froogaloop2.min.js";
                            var r = document.getElementsByTagName("script")[0];
                            var i = true;
                            e("head").find("*").each(function () {
                                if (e(this).attr("src") == k + "://a.vimeocdn.comjs/froogaloop2.min.js")i = false
                            });
